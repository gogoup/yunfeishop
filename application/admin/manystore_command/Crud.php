...
class Crud extends Command
{
    ...
    protected $fieldSelectpageMap = [
        'nickname' => ['user_id', 'user_ids', 'store_id', 'shop_id']
    ];
     ...
     * 保留字段
     */
    protected $reservedField = ['store_id','shop_id'];
    ...
    protected function execute(Input $input, Output $output)
    {
        ...
        $viewDir = $manystorePath . strtolower(implode(DS, $viewArr)) . DS;

        //最终将生成的文件路径
        $javascriptFile = ROOT_PATH . 'public' . DS . 'assets' . DS . 'js' . DS . 'manystore' . DS . $controllerBaseName . '.js';
        $addFile = $viewDir . 'add.html';
        $editFile = $viewDir . 'edit.html';
        $indexFile = $viewDir . 'index.html';
        $recyclebinFile = $viewDir . 'recyclebin.html';
        $langFile = $manystorePath . 'lang' . DS . Lang::detect() . DS . $controllerBaseName . '.php';
        ...
        require $manystorePath . 'common.php';
