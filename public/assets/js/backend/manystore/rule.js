define(['jquery', 'bootstrap', 'backend', 'table', 'form', 'template'], function ($, undefined, Backend, Table, Form, Template) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    "index_url": "manystore/rule/index",
                    "add_url": "manystore/rule/add",
                    "edit_url": "manystore/rule/edit",
                    "del_url": "manystore/rule/del",
                    "multi_url": "manystore/rule/multi",
                    "table": "manystore_auth_rule"
                }
            });
